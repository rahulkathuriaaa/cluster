                    ...
                    <main className="py-8">
                        <div className="flex flex-col md:flex-row gap-8 p-6">
                            ...
                            <div className="flex flex-col items-center md:w-1/2">
                                <h1 className={`text-4xl sm:text-5xl text-center font-bold text-yellow-500 mb-8 ${orbitron.className}tracking-widest`}>CANDY MACHINE</h1>
                            ...
                            <div className="md:w-1/2">
                                <h2 className="text-2xl sm:text-[2.75rem] tracking-wide font-bold text-yellow-500 mb-2">
                                    Hello, I'm Candy Machine,<br />
                                    a Self Chain AI Agent
                                </h2>

                                <div className="mb-8">
                                    <h3 className="text-yellow-500 text-xl sm:text-2xl font-bold my-5">HOW TO PLAY</h3>
                                    <ul className="space-y-2">
                                        <li className="flex items-start">
                                            <span className="text-yellow-500 mr-2">•</span>
                                            <span className='text-yellow-200'>SOLVE THE PUZZLE TO WIN THE PRIZE</span>
                                        </li>
                                        <li className="flex items-start">
                                            <span className="text-yellow-500 mr-2">•</span>
                                            <span className='text-yellow-200'>YOU HAVE 5 CREDITS FOR THE GAME</span>
                                        </li>
                                        <li className="flex items-start">
                                            <span className="text-yellow-500 mr-2">•</span>
                                            <span className='text-yellow-200'>BUY MORE IF YOU RUN OUT</span>
                                        </li>
                                        <li className="flex items-start">
                                            <span className="text-yellow-500 mr-2">•</span>
                                            <span className='text-yellow-200'>FUND EXPIRES IN 2 DAYS</span>
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div className="mb-6">
                                    <div className="border border-yellow-500/30 px-6 py-2 rounded">
                                        <div className="flex justify-between items-center">
                                            <span className="text-yellow-500 tracking-wide font-bold text-base sm:text-2xl">PRIZE POOL</span>
                                            <span className="text-xl sm:text-3xl tracking-wider font-bold text-yellow-500">1,000 APT</span>
                                        </div>
                                    </div>
                                    <div className="sm:text-xl text-gray-400">
                                        FUNDED BY SELF CHAIN AI • PARTICIPATE AT YOUR OWN RISK
                                    </div>
                                </div>

                                <div className="flex justify-end space-x-3">
                                    <a href="#" className="text-yellow-500 hover:text-yellow-400 border border-yellow-500/50 rounded p-1">
                                        <FaTwitter size={30} />
                                    </a>
                                    <a href="#" className="text-yellow-500 hover:text-yellow-400 border border-yellow-500/50 rounded p-1">
                                        <FaFacebook size={30} />
