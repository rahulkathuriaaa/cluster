        ...
        <div className="grid grid-rows-[auto_1fr_auto] min-h-screen bg-background text-foreground relative overflow-hidden">
          ...
          flex items-center justify-center overflow-hidden"
                >
                    <div className="absolute inset-0 opacity-20 bg-gradient-to-b from-[#555] to-transparent"></div>
                    <span
                        className={`text-primary text-xs uppercase ${orbitron.className} tracking-wider`}
                    >
                        TOOL LXP86F3
                    </span>
                </div>
            ...
            <div className="absolute left-0 top-[15%] bottom-[15%] w-8 flex flex-col justify-between z-20">
                <div className="h-1/3 border-r border-[#333] flex items-center justify-center">
                    <span
                        className={`text-primary text-xs uppercase transform -rotate-90 ${orbitron.className}`}
                    >
                        LUCIDA
                    </span>
                </div>
            ...
            <div className="absolute bottom-3 right-[30%] z-20">
                <span
                    className={`text-primary text-xs uppercase ${orbitron.className}`}
                >
                    FCM LABS
                </span>
            </div>
            ...
            <header className="flex justify-between items-center p-6 sm:p-10 z-10 border-b border-[#1a1a1a]">
                ...
                <div className="hidden md:flex items-center gap-4">
                    <span className="uppercase text-[#666] text-xs">
                        Lucida
                    </span>
                    <span className="uppercase text-primary text-xs">
                        Trial Layers
                    </span>
                </div>
            ...
            {/* Main Content */}
            <main className="flex flex-col md:flex-row items-center justify-center p-4 xs:p-6 sm:p-10 z-10 relative overflow-x-hidden">
                <div className="flex-1 max-w-xl">
                    <div className="flex items-center gap-2 mb-8">
                        ...
                        <div className="flex items-center">
                            ...
                            <div className="ml-3 px-4 py-1.5 border border-primary rounded-r-full rounded-l-sm bg-black/30">
                                <span
                                    className={`text-[#FFD700] text-sm font-bold tracking-wider ${orbitron.className}`}
                                >
                                    CLUSTER PROTOCOL
                                </span>
                            </div>
                    ...
                    <h1
                        className={`pixel-text text-4xl xs:text-5xl sm:text-6xl md:text-7xl lg:text-8xl mb-8 font-normal text-white uppercase leading-none tracking-wide ${vt323.className}`}
                        style={{ letterSpacing: "0.03em" }}
                    >
                        <span className="block mb-2 sm:mb-4">
                            Convince Zura
                        </span>
                        <span className="block mb-2 sm:mb-4">To Unlock</span>
                        <span className="block">The Vault</span>
                    </h1>

                    <button
                        className={`bg-primary hover:bg-[#e0be00] text-black text-xl py-4 px-12 mt-14 mb-4 border-[3px] border-solid border-[#B39700] ${vt323.className}`}
              ...
              <div className="h-4 w-full bg-gradient-to-r from-transparent via-primary to-transparent opacity-20 blur-md -mt-2"></div>
                        ...
                        <div className="absolute bottom-14 left-1/2 -translate-x-1/2 w-60 h-6">
                            ...
                            {/* Ripple circles */}
                            <div
                                className="absolute top-0 left-full -translate-x-1/2 w-48 h-[1px] border border-[#FFA500]/40 rounded-full animate-ripple"
                                style={{ animationDelay: "0s" }}
                            ></div>
                            <div
                                className="absolute top-0 left-1/2 -translate-x-1/2 w-36 h-[1px] border border-[#FFA500]/30 rounded-full animate-ripple"
                                style={{ animationDelay: "0.5s" }}
                            ></div>
                            <div
                                className="absolute top-0 left-1/2 -translate-x-1/2 w-24 h-[1px] border border-[#FFA500]/20 rounded-full animate-ripple"
                        ...
                        <div
                            className="absolute w-1 h-1 bg-primary rounded-full bottom-32 left-[35%] opacity-60 blur-sm animate-pulse-slow"
                            style={{ animationDelay: "0.7s" }}
                        ></div>
                        <div
                            className="absolute w-1.5 h-1.5 bg-primary rounded-full top-[40%] left-20 opacity-50 blur-sm animate-pulse-slow"
